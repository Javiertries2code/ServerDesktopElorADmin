 ...
 */
public enum Events {
	ON_UPDATE_ANSWER_FAILURE("ON_UPDATE_ANSWER_FAILURE"), ON_UPDATE_ANSWER_SUCCESS("ON_REGISTER_NEW_ANSWER_SUCCESS"),

	ON_REGISTER_STUDENT_ANSWER("ON_REGISTER_STUDENT_ANSWER"), ON_REGISTER_TEACHER_ANSWER("ON_REGISTER_TEACHER_ANSWER"),

	ON_REGISTER_STUDENT("ON_REGISTER_STUDENT"),

	ON_REGISTER_TEACHER("ON_REGISTER_TEACHER"),

	ON_USER_NOT_FOUND("ON_USER_NOT_FOUND"), ON_USER_NOT_FOUND_ANSWER("ON_USER_NOT_FOUND_ANSWER"),

	ON_REQUESTING_COURSES("ON_REQUESTING_COURSES"), ON_REQUESTING_COURSES_ANSWER("ON_REQUESTING_COURSES_ANSWER"),
